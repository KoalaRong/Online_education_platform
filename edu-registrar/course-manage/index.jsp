...
<html lang="zh-CN">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="course-manage/index.jsp">课程管理</a>
          </li>
          <li class="nav-item">
    ...
    <form action="courseview.jsp" method="POST">
      输入要查询的课程ID:<input type="text" name="id" />
      <input type="submit" value="查询" />
    </form>

    <form action="coursemod.jsp" method="POST">
      输入要修改的课程ID:<input type="text" name="id" />
      <input type="submit" value="修改" />
    </form>

    <form action="coursedel.jsp" method="POST">
      输入要删除的课程ID:<input type="text" name="id" />
