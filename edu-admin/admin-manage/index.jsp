...
<html lang="zh-CN">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="admin-manage/index.jsp">管理员管理</a>
          </li>
          <li class="nav-item">
    ...
    <form action="adminview.jsp" method="POST">
      输入要查询的管理员ID:<input type="text" name="id" />
      <input type="submit" value="查询" />
    </form>

    <form action="adminmod.jsp" method="POST">
      输入要修改的管理员ID:<input type="text" name="id" />
      <input type="submit" value="修改" />
    </form>

    <form action="admindel.jsp" method="POST">
      输入要删除的管理员ID:<input type="text" name="id" />
    ...
    <form action="adminadd.jsp" method="POST">
      输入要增加的管理员ID:<input type="text" name="id" />
      输入要增加的管理员密码:<input type="password" name="password" />
      输入要增加的管理员姓名:<input type="text" name="name" />
      输入要增加的管理员权限:<input type="text" name="authority" />
