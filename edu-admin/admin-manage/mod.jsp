...
<sql:update dataSource="${snapshot}" var="count">
    UPDATE admin SET id=<%= request.getParameter("id")%>,name ="<%= request.getParameter("name")%>",password=<%= request.getParameter("password")%>,authority=<%= request.getParameter("authority")%> WHERE id = <%= request.getParameter("id")%>;
</sql:update>
