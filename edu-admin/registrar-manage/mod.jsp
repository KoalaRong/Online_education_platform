...
<sql:update dataSource="${snapshot}" var="count">
    UPDATE registrar SET id=<%= request.getParameter("id")%>,name ="<%= request.getParameter("name")%>",password=<%= request.getParameter("password")%>,job="<%= request.getParameter("job")%>" WHERE id = <%= request.getParameter("id")%>;
</sql:update>
