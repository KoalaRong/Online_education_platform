...
<html lang="zh-CN">
  ...
  <body>
    ...
    <form action="teacherview.jsp" method="POST">
      输入要查询的教师ID:<input type="text" name="id" />
      <input type="submit" value="查询" />
    </form>

    <form action="teachermod.jsp" method="POST">
      输入要修改的教师ID:<input type="text" name="id" />
      <input type="submit" value="修改" />
    </form>

    <form action="teacherdel.jsp" method="POST">
    ...
    <form action="teacheradd.jsp" method="POST">
      ...
      输入要增加的教师职务:<input type="text" name="job" />
