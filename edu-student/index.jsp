...
<html lang="zh-CN">
  ...
  <sql:query dataSource="${snapshot}" var="result">
    SELECT * from student WHERE id = <%= session.getAttribute("userid")%>;
  </sql:query>
            ...
            <div class="col">
              <div class="card">
                ...
                <c:forEach var="row" items="${result.rows}">
                  ...
                  <p>班级：<c:out value="${row.class}"/></p>
                  <p>入学年份：<c:out value="${row.year}"/></p>
                  </c:forEach>
                ...
                <div class="card-body">
                  <div class="row">
                    <sql:query dataSource="${snapshot}" var="classresult">
                        SELECT * from class WHERE classid IN (SELECT classid FROM elective WHERE studentid = <%= session.getAttribute("userid")%>);
                      </sql:query>
